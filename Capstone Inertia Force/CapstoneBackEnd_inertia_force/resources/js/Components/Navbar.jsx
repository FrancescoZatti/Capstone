            ...
            <div className="container d-flex justify-content-between align-items-center">
                ...
                <Nav className="d-flex menu">
                    ...
                    >
                        ...
                        {
                            props.auth.user ? (
                                <section className="ms-5 w-100 mb-3" style={{ background: "none" }}>
                                    <Nav.Link
                                        className="nav_link"
                                        href="/tuoorto"
                                    >
                                    ...
                                    <Nav.Link className="nav_link" href="/scambi">
                                        Scambi
                                    </Nav.Link>
                                </section>
                                ...
                                <div>
                                    <div>
                                        <Nav.Link
                                            ...
                                            as="button"
                                            className="nav_link"
                                            style={{borderTop: "1px solid #036d19", width:"auto", margin:"0", padding:"0"}}
                                        >
                                            Log Out
                                        </Nav.Link>
                                    </div>
                    ...
                    <div className="menu d-flex align-items-center gap-3 d-none d-lg-flex">
                        ...
                        <div className="dropdown-center">
                            ...
                            ></button>
                            <ul
                                className="dropdown-menu dropdown-menu.hide position-absolute top-100 mt-2"
