...
export default function Welcome({ auth, laravelVersion, phpVersion }) {
    return (
        <>
            <Head title="Welcome" />
            <div className="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-primary dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
