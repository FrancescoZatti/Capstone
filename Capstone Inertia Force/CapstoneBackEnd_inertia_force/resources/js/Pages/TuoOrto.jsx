...
import Zucchina from "@/assets/img/zucchina.png";
import Melanzana from "@/assets/img/melanzana.png";
import Zucca from "@/assets/img/zucca.png";
import Carota from "@/assets/img/carota.png";
import Cipolla from "@/assets/img/cipolla.png"; 

// Mappa dei nomi degli ortaggi con le relative immagini
const ortaggioImages = {
    Pomodoro: Pomodoro,
    Zucchina: Zucchina,
    Melanzana: Melanzana,
    Zucca: Zucca,
...
export default function TuoOrto({ ortaggi, auth }) {
    ...
    return (
        <Layout>
            <div className="px-2 d-flex flex-column align-items-center justify-content-center" style={{ minHeight: "65vh" }}>
                <div className="container ortocontainer text-center my-3">
                    ...
                    >
                        {ortaggiFiltered.length === 0 ? (
                            <div className="text-center">
                                <p>Non hai ortaggi, il tuo orto è vuoto!</p>
                            </div>
                        ) : (
                                        ...
                                        <div className="col-12">
                                            <div className="row align-items-center">
                                                <div className="col-6 d-flex align-items-center">
                                                    <div className="col-4">
                                                        {/* Utilizzo dell'immagine corrispondente al nome dell'ortaggio */}
                                                        <img
                                                            src={ortaggioImages[ortaggio.name]}
                                                            alt={ortaggio.name}
                                                        />
                                                    </div>
